   ...
   ResultSet rs = null;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      try{
          ...
          + "(SSN, Firstname, Lastname, Check_In, Check_Out, Number_Of_Rooms)"
                  +" VALUES (?,?,?,?,?,?)";
...
JOptionPane.showMessageDialog(null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      try{
          String sql ="UPDATE customer SET Firstname=?,Lastname=?,Check_In=?,Check_Out=?,Number_Of_Rooms=? WHERE SSN=?";
           con = DriverManager.getConnection("jdbc:mysql://localhost/customer","root","");
            pst = con.prepareStatement(sql);
pst.setString(1,Lname.getText());
pst.setString(2,Fname.getText());
pst.setString(6,SSN.getText());
pst.setString(3,IN.getText());
pst.setString(4,OUT.getText());
